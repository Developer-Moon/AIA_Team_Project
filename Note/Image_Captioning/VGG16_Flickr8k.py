...
'''
features = {}
directory = os.path.join('D:/_AIA_Team_Project_Data/_captioning_data/Flickr8k/Images')
...
pickle.dump(features, open(os.path.join('D:/_AIA_Team_Project_Data/_captioning_save/Flickr8k/VGG16_Flickr8k_Feature.pkl'), 'wb'))
...
# save the model
model.save('D:/_AIA_Team_Project_Data/_captioning_save/Flickr8k/VGG16_Flickr8k_Model.h5')
'''
